...
public class NetworkHudCanvases : MonoBehaviour
{
    ...
    // Añade esta línea para especificar la dirección IP del servidor directamente en el código
    private string serverIpAddress = "192.168.1.139";
#endif
    #endregion
    ...
    public void OnClick_Client()
    {
        ...
        if (_clientState != LocalConnectionState.Stopped)
            ...
            _networkManager.ClientManager.StartConnection(serverIpAddress);
